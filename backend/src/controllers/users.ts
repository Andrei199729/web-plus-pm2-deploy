...
const updateUserInfo = (req: Request, res: Response, next: NextFunction) => updateUserData(req, res, next);

const updateUserAvatar = (req: Request, res: Response, next: NextFunction) => updateUserData(req, res, next);
